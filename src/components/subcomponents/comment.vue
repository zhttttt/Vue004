<template>
    <div class="cmt-container">
        <h3>发表评论</h3>
        <hr>
        <textarea placeholder="请输入要说的内容(最多120个字)" maxlength="120" v-model="msg"></textarea>

        <mt-button type="primary" size="large" @click="postComment">这是发表评论</mt-button>
        <div class="cmt-list">
...
export default {
    ...
    methods: {
        ...
        //参数3：定义提交的时候，表单中数据的格式{ emulateJSON:true } 我在main里设置的根 所以这可以省略 
